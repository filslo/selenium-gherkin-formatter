const FORMATTER_ID = 'selenium-gherkin-formatter@github';

function initializeformatterObserver()
{
    formatterObserver.register();
}

var formatterObserver =
{
    _uninstall: false,
        ...
        else if(topic == "quit-application-granted")
        {
            ...
            { // your uninstall stuff goes here
                ...
                if(typeof current_ppf != "undefined")
                {
                    ...
                    {
                        if(split_ppf[ppf].search("chrome://gherkinformatter/content/formats/Gherkin-formatter.js") != -1)
                        {
                ...
                branch.deleteBranch('gherkinformatter'); // remove custom branch

                // Remove custom branch
                branch.deleteBranch('formats.gherkinformatter'); // remove custom branch
            }
            this.unregister();
        }
    }, register: function()
...
window.addEventListener("load", initializeformatterObserver, false);
0
